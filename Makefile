...
jre: native 
	...
	cd $(SOURCEDIR); \
	rm -rf $(SOURCEDIR)/depends/java-*-openjdk/{ASSEMBLY_EXCEPTION,bin,conf,include,jre,legal,LICENSE,man,release,THIRD_PARTY_README,lib/{ct.sym,libjsig.dylib,src.zip,tools.jar}}; \
