...
void loadPreferences(BOOL reset) {
    ...
    setDefaultValueForPref(prefDict, @"hidden_sidebar", @NO);
    ...
    setDefaultValueForPref(debugPrefDict, @"debug_ipad_ui", @(UIDevice.currentDevice.userInterfaceIdiom != UIUserInterfaceIdiomTV));
